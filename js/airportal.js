...
var backend,currentExpTime,fileBackend,notificationTimeout;
...
function loadPrice(priceInfo){
	...
	Object.keys(priceInfo).forEach(function(key){
		...
		if((priceInfo[key]["discount"]===true||priceInfo[key]["discount"]<1)&&priceInfo[key]["specialPrice"]!=priceInfo[key]["price"]){
			var newSpan=document.createElement("span");
...
btnClose4.onclick=function(){
	popSendText.style.opacity="0";
	mainBox.style.opacity="1";
	setTimeout(function(){
		popSendText.style.display="none";
	},250);
}
